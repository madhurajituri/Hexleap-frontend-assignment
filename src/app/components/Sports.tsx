...
function Sports() {
    ...
    return (
        <div>
            ...
            <div className='card my-[25px] flex items-center justify-center gap-[14.09px]'>
                {
                    cardContent.map((item, index) => {
                        return <div className='w-[238.53px] h-[511px] shadow-[0_8px_16px_0_rgba(0,0,0,0.05)] py-[10px] px-[10.06px] dark:bg-[#3B3E47] dark:text-white' key={index}>
                            ...
                            <div className='mt-[14.69px] Inter font-[500] text-[17px] leading-[20.57px]'>{item.heading}</div>
                            <div className='w-[218.4px] h-[54px] mt-4 flex gap-[39.25px] px-[10.06px] py-3 bg-[#F7F7F8] dark:bg-[#292B32]'>
            ...
            <div className='mt-[50px] flex justify-center'>
                <div className='w-[124.8px] h-[46px] rounded-[3px] bg-[#2C9CF0] flex items-center justify-center'>
